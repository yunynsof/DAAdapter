...
public class DACreateMPMockTaskTest extends AbstractTest{

	public DACreateMPMockTaskTest() throws Exception {
		super("java:global/DAAdapter/DACreateMPMockTask!hn.com.tigo.josm.common.adapter.task.Task");
	}
