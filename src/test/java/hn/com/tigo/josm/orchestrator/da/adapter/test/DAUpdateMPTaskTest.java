...
public class DAUpdateMPTaskTest extends AbstractTest{

	public DAUpdateMPTaskTest() throws Exception {
		super("java:global/DAAdapter/DAUpdateMPTask!hn.com.tigo.josm.common.adapter.task.Task");
	}
	@Test
	public void test()  {
