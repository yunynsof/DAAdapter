...
public class DACreateIncluAndExcluTaskTest extends AbstractTest{

	public DACreateIncluAndExcluTaskTest() throws Exception {
		super("java:global/DAAdapter/DACreateIncluAndExcluTask!hn.com.tigo.josm.common.adapter.task.Task");
	}
	@Test
	public void test()  {
